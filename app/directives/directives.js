            ...
            function render(topLevel) {
                ...
                var Icon = React.createClass({
                    render: function() {
                        ...
                        return (<i onClick={this.props.onExpand} className={classes} />);
                    }
                })
                        ...
                        return (<div>
                                    <div style={selectedStyle}>
                                       <Icon type={type}
                                        ...
                                        <i className={classes} /> {' '}
                                        <span onClick={this.setSelectedItem}>{name}</span>
                                    </div>
                                    <Tree items={this.state.children}/>
                                </div>);
                    }
                });
                        ...
                        return (
                            <div>
                                {this.props.items.map(function(item) {
                                    return <Node setSelectedItem={self.setSelectedItem}
                                                 key={item.name}
                                                 data={item}/>;
                                })}
                            </div>
